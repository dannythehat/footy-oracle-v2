    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, mlService_1.mlService.getBetBuilder(today)];
            case 1:
                data = _a.sent();
                return [2 /*return*/, res.json({ success: true, data: data })];
            case 2:
                err_1 = _a.sent();
                console.error('Bet Builder error:', err_1.message);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, mlService_1.mlService.getBetBuilder(date)];
            case 1:
                data = _a.sent();
                return [2 /*return*/, res.json({ success: true, data: data })];
            case 2:
                err_2 = _a.sent();
                console.error('Bet Builder history error:', err_2.message);
