...
router.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var date, start, end, fixtures, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                start = new Date("".concat(date, "T00:00:00Z"));
...
router.get("/today", function (req, res) {
    ...
    return res.redirect("/api/fixtures?date=".concat(today));
});
router.get("/:dateParam", function (req, res) {
    var d = req.params.dateParam;
    if (/^\d{4}-\d{2}-\d{2}$/.test(d)) {
        return res.redirect("/api/fixtures?date=".concat(d));
    }
