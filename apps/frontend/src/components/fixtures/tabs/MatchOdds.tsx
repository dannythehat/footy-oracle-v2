...
const MatchOdds: React.FC<MatchOddsProps> = ({ fixture }) => {
  ...
  const renderMarket = (market: Market) => {
    ...
    return (
      <div
        key={market.id}
        className={`bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border transition-all ${
          isGolden
        ...
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1">
              <h3 className="text-white font-semibold">{market.label}</h3>
              {isGolden && (
                <div className="flex items-center gap-1 px-2 py-0.5 bg-yellow-400/20 rounded-full">
  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <h2 className="text-lg font-bold text-white">Footy Oracle Markets</h2>
      </div>
